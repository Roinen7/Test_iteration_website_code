...
export default function Awards() {
  return (
    <section id="awards" className="py-20 scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-pink-500/5 rounded-full blur-3xl w-96 h-96 top-1/4 left-1/3 pointer-events-none animate-pulse"></div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-left relative z-10">
