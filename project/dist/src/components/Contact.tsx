...
export default function Contact() {
  return (
    <section id="contact" className="py-20 text-white scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-pink-500/5 rounded-full blur-3xl w-96 h-96 top-1/3 left-1/4 pointer-events-none animate-pulse" style={{ animationDelay: '0.4s' }}></div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-in-left relative z-10">
