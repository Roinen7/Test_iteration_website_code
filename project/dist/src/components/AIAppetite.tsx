...
export default function AIAppetite() {
  return (
    <section id="aiappetite" className="py-20 scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-cyan-500/5 rounded-full blur-3xl w-96 h-96 bottom-1/4 right-1/2 pointer-events-none animate-pulse" style={{ animationDelay: '0.7s' }}></div>
