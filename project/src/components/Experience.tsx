...
const experiences = [
  ...
  },
  {
    ...
    description: [
      ...
      'Created engaging content highlighting university experience and opportsrc/components/Experience.tsxunities in Germany',
    ],
                ...
                {exp.position === 'Research Assistant' && (
                  <div className="mt-6 flex justify-end">
                    <a
                      ...
                      className="inline-flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-cyan-500 to-pink-500 text-white text-sm rounded-lg font-medium hover:scale-105 transition-all shadow-lg shadow-pink-500/20 border border-cyan-400/20"
                    >
