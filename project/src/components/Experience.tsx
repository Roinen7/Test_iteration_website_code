...
export default function Experience() {
  return (
    <section id="experience" className="py-20 scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-pink-500/5 rounded-full blur-3xl w-96 h-96 bottom-1/3 right-1/4 pointer-events-none animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-zoom-in relative z-10">
        ...
        <div className="mt-16 flex justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-pink-500 text-white rounded-lg font-semibold hover:from-cyan-600 hover:to-pink-600 transition-all hover:scale-105 shadow-lg shadow-cyan-500/50 text-lg"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 7v10m0 0l-3-3m3 3l3-3m0 0H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2z" />
            </svg>
            Check out my Resume
          </a>
        </div>
