...
export default function About() {
  return (
    <section id="about" className="py-20 scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-cyan-500/5 rounded-full blur-3xl w-96 h-96 top-1/3 left-1/4 pointer-events-none animate-pulse"></div>
