    ...
    <section ref={ref} id="about" className="py-20 scroll-mt-16 relative overflow-hidden">
      ...
      >
        ...
        <motion.div variants={containerVariants} className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <motion.div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg flex items-center justify-center mb-4" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
          ...
          <motion.div
            ...
            className="bg-gray-900/80 p-6 rounded-xl hover:shadow-lg transition-shadow border border-cyan-400/20 hover:border-cyan-400/50 backdrop-blur-sm"
          >
            <motion.div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-pink-600 rounded-lg flex items-center justify-center mb-4" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
          ...
          <motion.div
            ...
            className="bg-gray-900/80 p-6 rounded-xl hover:shadow-lg transition-shadow border border-cyan-400/20 hover:border-cyan-400/50 backdrop-blur-sm"
          >
            <motion.div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mb-4" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
          ...
          <motion.div
            ...
            className="bg-gray-900/80 p-6 rounded-xl hover:shadow-lg transition-shadow border border-cyan-400/20 hover:border-cyan-400/50 backdrop-blur-sm"
          >
            <motion.div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-pink-500 rounded-lg flex items-center justify-center mb-4" whileHover={{ rotate: 360 }} transition={{ duration: 0.6 }}>
