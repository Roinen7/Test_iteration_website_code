import { Mail, Linkedin, MapPin, Phone, FileText, MessageSquare } from 'lucide-react';
    ...
    <section id="contact" className="py-20 text-white scroll-mt-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-slide-up relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 mb-16">
          ...
          <a
            href="https://wa.me/qr/4XZ53V4W2IWZM1"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gray-900/80 rounded-xl p-6 hover:bg-gray-800 transition-all hover:scale-105 border border-cyan-400/20 hover:border-cyan-400/50"
          >
            ...
            <p className="text-slate-300 text-sm">Open chat</p>
          </a>
