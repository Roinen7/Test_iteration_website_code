            ...
            return (
              <motion.div key={index} variants={itemVariants}>
                <Component
                  ...
                  className="bg-gray-900/80 rounded-xl p-6 hover:bg-gray-800 transition-all border border-cyan-400/20 hover:border-cyan-400/50 w-full text-center backdrop-blur-sm h-full cursor-pointer"
                  whileHover={{
                    scale: 1.05,
                    y: -8,
                ...
                >
                  <motion.div
                    className={`w-10 h-10 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center mb-3 mx-auto`}
