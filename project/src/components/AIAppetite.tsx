...
type AIAppetiteProps = {
  compact?: boolean;
};

export default function AIAppetite({ compact = false }: AIAppetiteProps) {
  return (
    <section id="aiappetite" className={`${compact ? 'py-8' : 'py-20'} scroll-mt-16 relative overflow-hidden`}>
