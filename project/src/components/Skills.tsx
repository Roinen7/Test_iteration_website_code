...
const skillCategories = [
  ...
  },
  {
    ...
    icon: Code,
    skills: ['• Video Editing (Da Vinci Resolve, Premier Pro, Capcut)', '• Photo Editing (Photoshop, Lightroom)', '• Sound Editing (Audition, Audacity)', '• Content Creation', '• Agile and Lean frameworks', '• Pitch deck design', '• CRM system management', '• MS Office', '• Google G Suite', '• Trello', '• Notion', '• Slack', '• Zapier', '• N8n'],
    color: 'orange',
