...
export default function Skills() {
  return (
    <section id="skills" className="py-20 scroll-mt-16 relative z-20">
      <div className="absolute inset-0 bg-cyan-500/5 rounded-full blur-3xl w-96 h-96 top-1/2 right-1/3 pointer-events-none animate-pulse" style={{ animationDelay: '0.3s' }}></div>
