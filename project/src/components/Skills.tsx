import { Brain, TrendingUp, Users, Code, Globe, Award, ExternalLink } from 'lucide-react';
                      ...
                      <li key={idx} className="flex items-start gap-2 text-slate-300 hover:text-slate-100 transition-colors">
                        ...
                        {isObject ? (
                          <a
                            ...
                            className="group flex w-full justify-between items-center gap-4 no-underline hover:text-slate-100 transition-colors"
                          >
                            <span className="flex-1">{skill.label}</span>
                            <ExternalLink size={16} className="ml-3 opacity-60 group-hover:opacity-100 transform group-hover:scale-110 transition-all text-slate-300 group-hover:text-rose-400" />
                          </a>
                        ) : (
                          <span>{skill}</span>
                        )}
